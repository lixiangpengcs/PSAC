...
def parse_args():
    ...
    parser.add_argument('--glove_file_path', type=str, default='/path_to_glove/glove.6B.300d.txt')
    parser.add_argument('--feat_category',type=str,default='resnet')
    parser.add_argument('--feat_path',type=str,default='/path_to_gifqa_feature')
